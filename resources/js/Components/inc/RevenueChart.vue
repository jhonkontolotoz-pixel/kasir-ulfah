<template>
    <div class="card flex justify-between gap-3">
        ...
        <div class="flex justify-between gap-3">
            <DatePicker v-model="filters.date_from" showIcon fluid iconDisplay="input" inputId="icondisplay"
                placeholder="From" />
            <DatePicker v-model="filters.date_to" showIcon fluid iconDisplay="input" inputId="icondisplay"
                placeholder="To" />
